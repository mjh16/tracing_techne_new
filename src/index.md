...
<figcaption>Annotated line graph that showing impressions of <i>techne</i> by year. The lines illustrate the mean weights on topics developed by topic modeling with changes in the mean weight charter per year. The graph is annotated to illustrate five selected topics.</figcaption>
</figure>
